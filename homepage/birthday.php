        ...
        <div class="wrapper">
            <div class="service-content">
                ...
                <div class="see-more-photos">
                    <a href="birthday-gallery.php" target="_blank">See More Photos</a>
                </div>
            ...
            <div class="right-service">
                <div class="service-booking">
                    ...
                    <div class="available-services">
                        ...
                        <ul>
                            <li>Birthday Photo Only</li>
                            <li>Birthday Photo and Video</li>
                            <li>Pre-Birthday Photo Only</li>
                            <li>Pre-Birthday Photo and Video</li>
                        </ul>
