...
<head>
    ...
    <title>
        <?php echo "Christening-Gallery | ICSM Creatives"; ?>
    </title>
...
<body>
    <div class="gallery_page">
        <h1>Christening Memories</h1>
    </div>
    <main class="events-container">
        <div class="birthday-gallery-wrapper">
            <!----Line 1--->
            <div class="birthday-gallery-item portrait">
                <img src="../picture/christening2.jpg" alt="Birthday Celebration 2">
            </div>
            <div class="birthday-gallery-item landscape">
                <img src="../picture/christening7.jpg" alt="Birthday Celebration 1">
            </div>
            <div class="birthday-gallery-item portrait">
                <img src="../picture/christening5.jpg" alt="Birthday Celebration 3">
            </div>

            <!----Line 2---->
            <div class="birthday-gallery-item portrait">
                <img src="../picture/christening15.jpg" alt="Birthday Celebration 5">
            </div>
            <div class="birthday-gallery-item portrait">
                <img src="../picture/christening13.jpg" alt="Birthday Celebration 3">
            </div>
            <div class="birthday-gallery-item landscape">
                <img src="../picture/christening.jpg" alt="Birthday Celebration 4">
            </div>
            <!----Line 3---->
            <div class="birthday-gallery-item landscape">
                <img src="../picture/christening12.jpg" alt="Birthday Celebration 6">
            </div>
            <div class="birthday-gallery-item portrait">
                <img src="../picture/christening16.jpg" alt="Birthday Celebration 5">
            </div>
            <div class="birthday-gallery-item portrait">
                <img src="../picture/christening14.jpg" alt="Birthday Celebration 5">
            </div>
        </div>
