...
<head>
    ...
    <title>
        <?php echo "Maternity-Gallery | ICSM Creatives"; ?>
    </title>
...
<body>
    <div class="gallery_page">
        <h1>Maternity Memories</h1>
    </div>
    <main class="events-container">
        <div class="birthday-gallery-wrapper">
            <!----Line 1--->
            <div class="birthday-gallery-item portrait">
                <img src="../picture/pregy.jpg" alt="Birthday Celebration 2">
            </div>
            <div class="birthday-gallery-item landscape">
                <img src="../picture/maternityy.jpg" alt="Birthday Celebration 1">
            </div>
            <div class="birthday-gallery-item portrait">
                <img src="../picture/genderreveal5.jpg" alt="Birthday Celebration 3">
            </div>

            <!----Line 2---->
            <div class="birthday-gallery-item portrait">
                <img src="../picture/genderreveal6.jpg" alt="Birthday Celebration 5">
            </div>
            <div class="birthday-gallery-item portrait">
                <img src="../picture/genderreveal1.jpg" alt="Birthday Celebration 3">
            </div>
            <div class="birthday-gallery-item landscape">
                <img src="../picture/genderreveal4.jpg" alt="Birthday Celebration 4">
            </div>
        </div>
