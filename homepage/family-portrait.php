...
<head>
    ...
    <title>
        <?php echo "Family | ICSM Creatives"; ?>
    </title>
        ...
        <div class="wrapper">
            <div class="service-content">
                <div class="service-details">
                    <h2>FAMILY</h2>
                    <p>Family is where love grows and memories are made. At ICSM Creatives, we capture the laughter, the
                        bonds, and the little moments that make your family unique. Let us create beautiful images that
                        celebrate your togetherness, preserving memories you'll cherish for a lifetime.
                ...
                <div class="gallery-carousel">
                    ...
                    <div class="gallery-item">
                        <img src="../picture/family.jpg" alt="Team-Picture">
                        <img src="../picture/family5.jpg" alt="Birthday Celebration">
                        <img src="../picture/girls.jpg" alt="picture">
                        <img src="../picture/familyy.jpg" alt="picture">
                        <img src="../picture/family10.jpg" alt="picture">
                        <img src="../picture/family3.jpg" alt="picture">
                        <img src="../picture/family7.jpg" alt="picture">
                        <img src="../picture/family9.jpg" alt="Sample Image 6">
                        <img src="../picture/family8.jpg" alt="Sample Image 7">
                        <img src="../picture/family1.jpg" alt="Sample Image 8">
                    </div>
                    <button class="carousel-btn right-btn"><i class="fa-solid fa-chevron-right"></i></button>
                </div>

                <div class="see-more-photos">
                    <a href="family-gallery.php" target="_blank">See More Photos</a>
                </div>
            ...
            <div class="right-service">
                <div class="service-booking">
                    ...
                    <div class="available-services">
                        ...
                        <ul>
                            <li>Photo Only</li>
                            <li>Video Highlisights Only</li>
                            <li>Photo and Video</li>
                            <li>Photo and SDE Edit </li>
                        </ul>
