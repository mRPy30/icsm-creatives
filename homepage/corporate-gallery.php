...
<head>
    ...
    <title>
        <?php echo "Corporate-Gallery | ICSM Creatives"; ?>
    </title>
...
<body>
    <div class="gallery_page">
        <h1>Corporate Memories</h1>
    </div>
    <main class="events-container">
        <div class="birthday-gallery-wrapper">
            <!----Line 1--->
            <div class="birthday-gallery-item portrait">
                <img src="../picture/corporate15.jpg" alt="Birthday Celebration 2">
            </div>
            <div class="birthday-gallery-item landscape">
                <img src="../picture/corporate1.jpg" alt="Birthday Celebration 1">
            </div>
            <div class="birthday-gallery-item portrait">
                <img src="../picture/corporate9.jpg" alt="Birthday Celebration 3">
            </div>

            <!----Line 2---->
            <div class="birthday-gallery-item portrait">
                <img src="../picture/corpoo.jpg" alt="Birthday Celebration 5">
            </div>
            <div class="birthday-gallery-item portrait">
                <img src="../picture/corporate7.jpg" alt="Birthday Celebration 3">
            </div>
            <div class="birthday-gallery-item landscape">
                <img src="../picture/corporate5.jpg" alt="Birthday Celebration 4">
            </div>
            <!----Line 3---->
            <div class="birthday-gallery-item landscape">
                <img src="../picture/corporate3.jpg" alt="Birthday Celebration 6">
            </div>
            <div class="birthday-gallery-item portrait">
                <img src="../picture/corporate11.jpg" alt="Birthday Celebration 5">
            </div>
            <div class="birthday-gallery-item portrait">
                <img src="../picture/corpo.jpg" alt="Birthday Celebration 5">
            </div>
            <!----Line 4---->
            <div class="birthday-gallery-item portrait">
                <img src="../picture/corporate6.jpg" alt="Birthday Celebration 5">
            </div>
            <div class="birthday-gallery-item landscape">
                <img src="../picture/corporate10.jpg" alt="Birthday Celebration 6">
            </div>
            <div class="birthday-gallery-item portrait">
                <img src="../picture/corporate12.jpg" alt="Birthday Celebration 5">
            </div>
        </div>
