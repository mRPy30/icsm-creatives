...
<head>
    ...
    <title>
        <?php echo "Family-Gallery | ICSM Creatives"; ?>
    </title>
    ...
    <main class="events-container">
        <div class="birthday-gallery-wrapper">
            ...
            <div class="birthday-gallery-item portrait">
                <img src="../picture/family3.jpg" alt="Birthday Celebration 2">
            </div>
            <div class="birthday-gallery-item landscape">
                <img src="../picture/family5.jpg" alt="Birthday Celebration 1">
            </div>
            <div class="birthday-gallery-item portrait">
                <img src="../picture/family4.jpg" alt="Birthday Celebration 3">
            </div>

            <!----Line 2---->
            <div class="birthday-gallery-item portrait">
                <img src="../picture/family6.jpg" alt="Birthday Celebration 5">
            </div>
            <div class="birthday-gallery-item portrait">
                <img src="../picture/family1.jpg" alt="Birthday Celebration 3">
            </div>
            <div class="birthday-gallery-item landscape">
                <img src="../picture/family.jpg" alt="Birthday Celebration 4">
            </div>
            <!----Line 3---->
            <div class="birthday-gallery-item landscape">
                <img src="../picture/family2.jpg" alt="Birthday Celebration 6">
            </div>
            <div class="birthday-gallery-item portrait">
                <img src="../picture/family11.jpg" alt="Birthday Celebration 5">
            </div>
            <div class="birthday-gallery-item portrait">
                <img src="../picture/family13.jpg" alt="Birthday Celebration 5">
            </div>
        </div>
