...
<head>
    ...
    <title>
        <?php echo "Wedding | ICSM Creatives"; ?>
    </title>
        ...
        <div class="wrapper">
            <div class="service-content">
                <div class="service-details">
                    <h2>WEDDING</h2>
                    <p>Your wedding day is a celebration of love, laughter, and new beginnings. At ICSM Creatives, we
                        capture the magic of each moment, turning your memories into timeless treasures. Let us tell
